	...
	while (i < argc)
	{
		...
		if (equal == NULL) // key without value args cases
		{
			...
			while (g_all.env[j] != NULL)
			{
				...
				if (equal != NULL)
				{
					if (ft_strlen(ft_substr(g_all.env[j], 0, ft_strlen(g_all.env[j]) - ft_strlen(ft_strchr(g_all.env[j], '=')) // free
						== ft_strlen(str[i]))) && !(ft_strncmp(ft_substr(g_all.env[j], 0, ft_strlen(g_all.env[j]) - ft_strlen(ft_strchr(g_all.env[j], '='))),
							str[i], ft_strlen(str[i]))))
					{
		...
		else if (equal != NULL) // key with value args cases
		{
			...
			while (g_all.env[j] != NULL)
			{
				...
				if (equal == NULL)
				{
					if (ft_strlen(g_all.env[j]) == ft_strlen(ft_substr(str[i], 0, ft_strlen(str[i]) - ft_strlen(ft_strchr(str[i], '=')))) 
							&& !(ft_strncmp(g_all.env[j],
				...
				if (equal != NULL)
				{
					if (ft_strlen(ft_substr(g_all.env[j], 0, ft_strlen(g_all.env[j]) - ft_strlen(ft_strchr(g_all.env[j], '=')) 
						== ft_strlen(ft_substr(str[i], 0, ft_strlen(str[i]) - ft_strlen(ft_strchr(str[i], '=')))))) 
						&& ft_strncmp(ft_substr(g_all.env[j], 0, ft_strlen(g_all.env[j]) - ft_strlen(ft_strchr(g_all.env[j], '='))),
							ft_substr(str[i], 0, ft_strlen(str[i]) - ft_strlen(ft_strchr(str[i], '='))),
